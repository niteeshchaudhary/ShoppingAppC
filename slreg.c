...
void read_user(){
	...
	seller_info.cur=ccpos;
	printf("%d",seller_info.no_of_sellers);
...
void load_images()
{
	hli=(HBITMAP)LoadImageW(NULL,L"./resources/regs.bmp",IMAGE_BITMAP,width,height,LR_LOADFROMFILE);
...
void create_controls(HWND hwnd)
{
	...
	itm_Pass=CreateWindowW(WC_EDITW, NULL,
	   WS_CHILD | WS_VISIBLE |ES_PASSWORD,
		625, 380, 330, 51, 
		hwnd, (HMENU) PASS, NULL, NULL);

	itm_cPass=CreateWindowW(WC_EDITW, NULL, 
	    WS_CHILD | WS_VISIBLE|ES_PASSWORD,
		625, 498, 330, 51, 
